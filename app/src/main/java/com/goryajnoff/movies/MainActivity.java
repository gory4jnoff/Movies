...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainViewModel.getMovieLiveData().observe(this, new Observer<List<Movie>>() {
            @Override
        ...
        }// делаем для того чтобы при разрушении активити не подргужало при создании
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()== R.id.itemFavourite){
            Intent intent = favourite_movies.newIntent(MainActivity.this);
            startActivity(intent);
        }
